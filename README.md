...
**production recommendations** if Decima2 were hosting the site for the client.
**Part 2** is an AI/automation demo. In the interview you will **walk us through
both** — your Part 1 fixes live on the site, not just your written notes, and
your Part 2 demo. Send Part 1 notes by email beforehand; keep the environment
running so you can show your work.
